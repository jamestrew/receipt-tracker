...
class Buyer(object):
    ...
    def from_dict(cls, dct):
        ...
        Args:
            dct (dict): Buyer information in the form of a dict.
    ...
    def to_dict(self):
        """Construct dictionary of Buyer instance.

        Returns:
            dict: Buyer information in the form of a dict.
        """
        return {
            'id': self.id,
            'name': self.name
...
class Receipt(object):
    ...
    Args:
        ...
        buyer (int): Foreign key from Buyer class.
        description (str): [Optional] Description of purchase (product, etc).
    """

    def __init__(self, id, date, business, total, buyer, description=None):
        self.id = id
        self.date = date
