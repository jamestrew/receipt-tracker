	...
	function (t, e, n) {
		var r = n(1),
			...
			o = function (t, e) {
				var n = s[a(t)];
				return (
					n == u || (n != l && ("function" == typeof e ? r(e) : !!e))
				);
			},
			...
			return [
				...
				function (t, o) {
					...
					for (var y = []; ; ) {
						...
						if ((y.push(b), !v)) break;
						"" === String(b[0]) &&
							(h.lastIndex = u(p, a(h.lastIndex), m));
					}
						...
						function (t, i) {
							...
							for (var x = 0, w = 0, S = []; w < f.length; ) {
								...
								if (
									...
									if ((S.push(f.slice(x, w)), S.length === b))
										return S;
									for (var M = 1; M <= C.length - 1; M++)
										if ((S.push(C[M]), S.length === b))
											return S;
									w = x = k;
								}
							}
							...
							value: function () {
								...
								this.$text.length &&
									...
									t(this.inputSelector).each(function (e, r) {
										...
										n.updateTextFields(i),
											o && n.toggleActiveClass(i, "add");
									}),
						...
						},
						{
							...
							value: function (t) {
								if (t.hasClass("validate")) {
									...
									if (n && r)
										t.removeClass("valid").removeClass(
											"invalid"
										);
									else {
					...
					return (
						o(e, [
							...
							},
							{
								...
								value: function () {
									return {
										animationName: this.$wowElement.css(
											"animation-name"
										),
										offset: 100,
										iteration: this.fallback()
											.or(
												this.$wowElement.data(
													"wow-iteration"
												)
											)
											.or(1)
							...
							},
							{
								...
								value: function () {
									var t = this;
									"visible" !==
										this.$wowElement.css("visibility") &&
										this.shouldElementBeVisible(!0) &&
										(setTimeout(function () {
											return t.$wowElement.removeClass(
												"animated"
											);
							...
							},
							{
								...
								value: function () {
									this.$wowElement.addClass("animated"),
										this.$wowElement.css({
											visibility: "visible",
											"animation-name": this.options
												.animationName,
											"animation-iteration-count": this
												.options.iteration,
											"animation-duration": this.options
												.duration,
											"animation-delay": this.options
												.delay,
										});
								},
							},
								...
								value: function () {
									...
									return (
										this.options.duration &&
											(e =
												t +
												this.checkOptionsStringFormat(
													this.options.duration
												)),
										this.options.delay &&
											(e += this.checkOptionsStringFormat(
												this.options.delay
											)),
										e
									);
						...
						destroy: function () {
							for (
								var e = [].slice
									...
									n = [].slice
										.call(
											document.querySelectorAll(t.INPUT)
										)
										.filter(function (t) {
											return !!t.bsCustomFileInput;
										}),
							...
							function (t, e, n) {
								...
								((a.prototype = {
									...
									(a.prototype.getValues = function (t) {
										for (
											var e = this.values, n = {}, r = 0;
											r < t.length;
											r++
										)
											n[t.charAt(r)] = e[t][r];
										return (
											1 !== e.alpha && (n.a = e.alpha), n
										);
									}),
									...
									(a.prototype.setChannel = function (
										t,
										e,
										n
									) {
						...
						4: [
							function (t, e, n) {
								...
								function p(t) {
									...
									return [
										255 *
											(1 - Math.min(1, e * (1 - i) + i)),
										255 *
											(1 - Math.min(1, n * (1 - i) + i)),
										255 *
											(1 - Math.min(1, r * (1 - i) + i)),
									];
								}
								function v(t) {
									var e,
									...
									return (
										...
										(e =
											(e =
												...
												-1.5372 * o +
												-0.4986 * a) > 0.0031308
												? 1.055 * Math.pow(e, 1 / 2.4) -
												  0.055
												: (e *= 12.92)),
										(n =
											n > 0.0031308
												? 1.055 * Math.pow(n, 1 / 2.4) -
												  0.055
												: (n *= 12.92)),
										(r =
											r > 0.0031308
												? 1.055 * Math.pow(r, 1 / 2.4) -
												  0.055
												: (r *= 12.92)),
										[
											255 *
												...
												updateElement: function (
													...
													var r = this,
														...
														u =
															i.options.elements
																.rectangle;
													(t._xScale = r.getScaleForId(
														a.xAxisID
													)),
														(t._yScale = r.getScaleForId(
															a.yAxisID
														)),
														(t._datasetIndex =
															r.index),
									...
									legend: {
										labels: {
											generateLabels: function (t) {
												...
												return e.labels.length &&
													e.datasets.length
													? e.labels.map(function (
															n,
															r
													  ) {
															var i = t.getDatasetMeta(
																	0
																),
																a =
																	e
										...
										onClick: function (t, e) {
											...
											for (
												...
												(i = a.getDatasetMeta(n)).data[
													o
												] &&
													(i.data[o].hidden = !i.data[
														o
													].hidden);
											a.update();
										},
												...
												updateElement: function (
													...
													void 0 !== c.radius &&
														...
														(t._model = {
															...
															rotation: s.getPointRotation(
																t,
																e
															),
															backgroundColor: s.getPointBackgroundColor(
																t,
																e
															),
															borderColor: s.getPointBorderColor(
																t,
																e
															),
															borderWidth: s.getPointBorderWidth(
																t,
																e
															),
															tension: l.dataset
								...
								e.exports = function (t) {
									...
									(t.types = {}),
										...
										s.extend(t.prototype, {
											...
											clear: function () {
												return (
													s.canvas.clear(this), this
												);
											},
											stop: function () {
												return (
													i.cancelAnimation(this),
													this
												);
											},
											resize: function (t) {
											...
											isDatasetVisible: function (t) {
												...
												return "boolean" ==
													typeof e.hidden
													? !e.hidden
													: !this.data.datasets[t]
															.hidden;
											},
											generateLegend: function () {
												return this.options.legendCallback(
													this
												);
											},
										...
										r.extend(
											t.DatasetController.prototype,
											{
												...
												addElements: function () {
													...
													n.dataset =
														n.dataset ||
														this.createMetaDataset();
												},
												addElementAndReset: function (
													t
												) {
													var e = this.createMetaData(
														t
													);
													this.getMeta().data.splice(
														t,
														0,
														e
													),
							...
							function (t, e, n) {
								...
								e.exports = function () {
									...
									(o.configMerge = function () {
										...
										(o.distanceBetweenPoints = function (
											t,
											e
										) {
											return Math.sqrt(
										...
										(o.getRelativePosition = function (
											t,
											e
										) {
											var n,
							...
							function (t, e, n) {
								...
								function u(t, e, n) {
									...
									var o = l(n.axis),
										...
										c = [];
									return u.length
										? (t.data.datasets.forEach(function (
												e,
												n
										  ) {
									...
									update: function (t, e, n) {
										if (t) {
											...
											var m = e - l - u,
												...
												k = y,
												C = [];
											r.each(f.concat(h, p, g), function (
												t
											) {
												var e,
													n = t.isHorizontal();
															...
															n.offset ===
																...
																? ((u =
																  ...
																  (c =
																		f.zeroLineColor),
																  (d =
																		f.zeroLineBorderDash),
																  (h =
																		f.zeroLineBorderDashOffset))
								...
								e.exports = {
									...
									registerScaleType: function (t, e, n) {
										(this.constructors[t] = e),
											(this.defaults[t] = i.clone(n));
									},
									getScaleConstructor: function (t) {
										return this.constructors.hasOwnProperty(
											t
										)
											? this.constructors[t]
											: void 0;
								...
								(e.exports = i.extend({
									...
									getTitle: function () {
										var t = this,
											e = t._options,
											n = e.callbacks,
											r = n.beforeTitle.apply(
												t,
												arguments
											),
											i = n.title.apply(t, arguments),
											o = n.afterTitle.apply(
												t,
												arguments
											),
											a = [];
									...
									getFooter: function () {
										var t = this,
											...
											n = e.beforeFooter.apply(
												t,
												arguments
											),
											r = e.footer.apply(t, arguments),
											i = e.afterFooter.apply(
												t,
												arguments
											),
											o = [];
											...
											f.filter &&
												...
												o.each(k, function (t) {
													w.push(
														...
														S.push(
															f.callbacks.labelTextColor.call(
																d,
																t,
																d._chart
															)
						...
						51: [
							function (t, e, n) {
								...
								function f(t, e, n, r, i) {
									...
									if (r && i) {
										for (
											t.moveTo(e[0].x, e[0].y), a = 1;
											a < r;
											++a
										)
											o.canvas.lineTo(t, e[a - 1], e[a]);
										for (
											t.lineTo(n[i - 1].x, n[i - 1].y),
												a = i - 1;
											a > 0;
											--a
										)
								...
								e.exports = function (t) {
									...
									t.LinearScaleBase = i.extend({
										getRightValue: function (t) {
											return "string" == typeof t
												? +t
												: i.prototype.getRightValue.call(
														this,
														t
												  );
										},
										...
										convertTicksToLabels: function () {
											...
											(t.ticksAsNumbers = t.ticks.slice()),
												(t.zeroLineIndex = t.ticks.indexOf(
													0
												)),
							...
							function (t, e, n) {
								...
								e.exports = function (t) {
									...
									function d(t, e, n, r) {
										if (i.isArray(e))
											for (
												var o = n.y, a = 1.5 * r, s = 0;
												s < e.length;
												++s
											)
												t.fillText(e[s], n.x, o),
													(o += a);
									...
									var p = t.LinearScaleBase.extend({
										setDimensions: function () {
											...
											(t.width = t.maxWidth),
												(t.height = t.maxHeight),
												(t.xCenter = Math.round(
													t.width / 2
												)),
												(t.yCenter = Math.round(
													t.height / 2
												));
										...
										determineDataLimits: function () {
											...
											i.each(e.data.datasets, function (
												o,
												a
											) {
												if (e.isDatasetVisible(a)) {
													var s = e.getDatasetMeta(a);
													i.each(o.data, function (
														e,
														i
													) {
														var o = +t.getRightValue(
															e
														);
														isNaN(o) ||
															s.data[i].hidden ||
										...
										setCenterPoint: function (t, e, n, r) {
											var i = this,
												...
												l =
													...
													r -
													i.drawingArea;
											(i.xCenter = Math.round(
												(a + o) / 2 + i.left
											)),
												(i.yCenter = Math.round(
													(s + l) / 2 + i.top
												));
										},
						...
						59: [
							function (t, e, n) {
								...
								function v(t, e) {
									...
									return r.isValid()
										? (n.round && r.startOf(n.round),
										  r.valueOf())
										: null;
								}
								function m(t) {
									for (
										var e = d.indexOf(t) + 1, n = d.length;
										e < n;
										++e
									)
										...
										getRightValue: function (t) {
											return (
												t &&
													void 0 !== t.t &&
													(t = t.t),
												a.prototype.getRightValue.call(
													this,
													t
												)
											);
				...
				(r = function (t) {
					...
					h.extend(m.prototype, {
							...
							return {
								...
								positioner:
									...
									a instanceof t.elements.Arc
										...
										: f.fallback),
								rotation:
									l([i.rotation, 0], o, s) * (Math.PI / 180),
						...
						update: function (t) {
							...
							c &&
								((e = t.dataset.data[l]),
								(n = h.valueOrDefault(
									h.callback(u.formatter, [e, t]),
									e
								)),
								(i = h.isNullOrUndef(n) ? [] : r.toTextLines(n))
									.length &&
									(s = (function (t) {
					...
					y.extend(C.prototype, {
						...
						contains: function (t) {
							var e = this._rect;
							return !(
								(t = w(t, this.center(), -this._rotation)).x <
									e.x - 1 ||
								t.y < e.y - 1 ||
								t.x > e.x + e.w + 2 ||
								t.y > e.y + e.h + 2
					...
					var E = {
						...
						afterEvent: function (e) {
							...
							for (n = 0, i = h.length; n < i; ++n)
								if ((s = h[n])[1])
									for (
										o = 0, a = (u = s[0][I] || []).length;
										o < a;
										++o
									)
										((l = u[o]).$context.active =
											1 === s[1]),
											l.update(l.$context);
							(c._dirty || h.length) &&
								(A.update(c._labels),
		...
		(jQuery.easing.jswing = jQuery.easing.swing),
			jQuery.extend(jQuery.easing, {
				...
				easeInBounce: function (t, e, n, r, i) {
					return (
						r - jQuery.easing.easeOutBounce(t, i - e, 0, r, i) + n
					);
				},
				...
				easeInOutBounce: function (t, e, n, r, i) {
					return e < i / 2
						? 0.5 * jQuery.easing.easeInBounce(t, 2 * e, 0, r, i) +
								n
						: 0.5 *
						...
						if (!t.jQuery) {
							...
							(n.isWindow = function (t) {
								...
								(n.dequeue = function (t, e) {
									n.each(t.nodeType ? [t] : t, function (
										t,
										r
									) {
										e = e || "fx";
							...
							function d(t, e) {
								...
								for (
									...
									if (
										...
										var h = !1;
										f.each(w.Lists.transforms3D, function (
											t,
											e
										) {
											...
											a(d).transformCache[e] !== i &&
												...
												((h = !0),
												delete a(d).transformCache[e]);
										}),
											o.mobileHA &&
												((h = !0),
												delete a(d).transformCache
													.translate3d),
											h && w.flushTransformCache(d),
											w.Values.removeClass(
												d,
												"velocity-animating"
											);
									}
								...
								b.State.calls[t] = !1;
								for (
									var p = 0, g = b.State.calls.length;
									g > p;
									p++
								)
									...
									Hooks: {
										...
										extractValue: function (t, e) {
											...
											if (n) {
												var r = n[0],
													i = n[1];
												return (e = w.Hooks.cleanRootPropertyValue(
													r,
													e
												))
													.toString()
													.match(w.RegEx.valueSplit)[
													i
												];
											}
											return e;
										...
										injectValue: function (t, e, n) {
											...
											if (r) {
												var i,
													...
													a = r[1];
												return (
													((i = (n = w.Hooks.cleanRootPropertyValue(
														o,
														n
													))
														.toString()
									...
									Normalizations: {
										...
										register: function () {
											...
											for (
												var t = 0;
												t <
												w.Lists.transformsBase.length;
												t++
											)
												!(function () {
													var e =
														w.Lists.transformsBase[
															t
														];
													w.Normalizations.registered[
														e
													...
													w.Normalizations.registered[
														...
														switch (t) {
															...
															case "extract":
																var o;
																if (
																	w.RegEx.wrappedValueAlreadyExtracted.test(
																		r
																	)
																)
																	o = r;
									...
									getPropertyValue: function (t, n, r, o) {
										...
										if (w.Hooks.registered[n]) {
											var u = n,
												c = w.Hooks.getRoot(u);
											r === i &&
												(r = w.getPropertyValue(
													t,
													w.Names.prefixCheck(c)[0]
												)),
												w.Normalizations.registered[
													c
												] &&
													(r = w.Normalizations.registered[
														c
													]("extract", t, r)),
												(l = w.Hooks.extractValue(
													u,
													r
												));
										} else if (
											...
											var d, p;
											"transform" !==
												(d = w.Normalizations.registered[
													n
												]("name", t)) &&
												((p = s(
													t,
													w.Names.prefixCheck(d)[0]
												)),
										...
										if (!/^[\d-]/.test(l))
											if (
												...
												l = s(
													t,
													w.Names.prefixCheck(n)[0]
												);
										return (
											w.Values.isCSSNullValue(l) &&
												(l = 0),
											b.debug >= 2 &&
												console.log(
													"Get " + n + ": " + l
									...
									setPropertyValue: function (t, n, r, i, o) {
										...
										if ("scroll" === n)
											...
											if (w.Hooks.registered[n]) {
												...
												(i =
													i ||
													w.getPropertyValue(t, u)),
													(r = w.Hooks.injectValue(
														l,
														r,
														i
													)),
													...
													if (
														...
														((s.display !== i &&
															...
															I[D]
																...
																? z === i
																	? ((W = w.getPropertyValue(
																			o,
																			B
																	  )),
																	  (z = w.getPropertyValue(
																			o,
																			D,
																			W
																	  )))
			  ...
			  (t.exports = function (t, e, n, o) {
					...
					R
						...
						"BYTES_PER_ELEMENT" in v ||
							d(v, "BYTES_PER_ELEMENT", e),
						"BYTES_PER_ELEMENT" in m ||
							d(m, "BYTES_PER_ELEMENT", e),
						C(s);
			  }))
			: (t.exports = function () {});
	},
				...
				function () {
					...
					var u = {
							...
							show: function (t, e, n) {
								...
								(r.className = "waves-ripple waves-rippling"),
									e.appendChild(r);
								var i = s(e),
									o = 0,
									a = 0;
								...
								r.classList.add("waves-notransition"),
									...
									(f.opacity = "1");
								var h =
									"mousemove" === t.type ? 2500 : u.duration;
						...
						if (n) {
							...
							var r = n.getAttribute("data-x"),
								...
								s =
									350 -
									(Date.now() -
										Number(n.getAttribute("data-hold")));
							s < 0 && (s = 0),
						...
						(t.attach = function (t, e) {
							...
							for (var o = 0, s = t.length; o < s; o++)
								(i = (n = t[o]).tagName.toLowerCase()),
									...
									-1 ===
										n.className.indexOf("waves-effect") &&
